...
/**
 * @file
 * Contains Drupal\ads_system\Controller\AdAddController.
 */
...
class AdAddController extends ControllerBase {
    ...
    public function add(Request $request) {
      ...
      return array('#theme' => 'ad_content_add_list', '#content' => $types);
    }

    /**
     * Presents the creation form for ad entities of given bundle/type.
     *
     * @param EntityInterface $ad_type
